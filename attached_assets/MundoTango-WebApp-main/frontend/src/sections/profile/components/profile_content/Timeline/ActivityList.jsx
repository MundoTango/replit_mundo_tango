...
const ActivityList = ({ onSetActivity, ActivityId, formData }) => {
  ...
  if (activityLoading) {
    return (
      <div className="bg-white rounded-2xl h-[35.4vh] p-5 flex items-center justify-center animate-fade-up mt-4">
        <SpinnerLoading />
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-2xl pt-5 px-3 animate-fade-up pb-3 mt-4">
