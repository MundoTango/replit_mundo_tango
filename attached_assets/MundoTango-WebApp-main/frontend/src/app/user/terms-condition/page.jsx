...
function Page() {
  ...
  return (
    <section className="p-4 my-2 mr-3 rounded-2xl bg-white max-h-screen">
      <h2 className="mb-3 text-2xl font-[700px]">Terms & Conditions</h2>
      ...
      <br />
      <h2 className="heading-text">Information We Collect</h2>
      <p className="mt-1 text-[#64748B] font-[400] text-[14px]">
        Sed ut perspiciatis unde omnis iste natus error sit voluptatem
        accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab
        illo inventore veritatis et quasi architecto beatae vitae dicta sunt
      ...
      <br />
      <h2 className="heading-text">Sharing Your Information</h2>
      <p className="mt-1 text-[#64748B] font-[400] text-[14px]">
        Sed ut perspiciatis unde omnis iste natus error sit voluptatem
        accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab
        illo inventore veritatis et quasi architecto beatae vitae dicta sunt
      ...
      <br />
      <h2 className="heading-text">Data Security</h2>
      <p className="mt-1 text-[#64748B] font-[400] text-[14px]">
        Sed ut perspiciatis unde omnis iste natus error sit voluptatem
        accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab
        illo inventore veritatis et quasi architecto beatae vitae dicta sunt
      ...
      <br />
      <h2 className="heading-text">Your Privacy Rights</h2>
      <p className="mt-1 text-[#64748B] font-[400] text-[14px]">
        Sed ut perspiciatis unde omnis iste natus error sit voluptatem
        accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab
        illo inventore veritatis et quasi architecto beatae vitae dicta sunt
      ...
      <br />
      <h2 className="heading-text">Third-Party Links</h2>
      <p className="mt-1 text-[#64748B] font-[400] text-[14px]">
        Sed ut perspiciatis unde omnis iste natus error sit voluptatem
        accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab
        illo inventore veritatis et quasi architecto beatae vitae dicta sunt
