...
class RestModel {
    ...
    constructor(orm) {
        ...
        this.__is_indexQueryHook = true;
        this.__is_singleQueryHook = true;
    }
    ...
    async getRecords(request, params = {}) {
        ...
        //query hook
        if (_.isFunction(this.indexQueryHook) && this.__is_indexQueryHook) {
    ...
    async getRecordBySlug(request, slug) {
        ...
        //query hook
        if (_.isFunction(this.singleQueryHook) && this.__is_singleQueryHook) {
