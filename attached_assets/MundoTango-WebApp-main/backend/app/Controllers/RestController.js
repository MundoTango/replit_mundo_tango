...
class RestController extends Controller {
    ...
    async index({ request, response }) {
        try {
            ...
            let records = await this.modal.getRecords(request, params);
    ...
    async store({ request, response }) {
        try {
            ...
            let record = await this.modal.createRecord(request, extractFields(request.body, this.modal.getFields()));
    ...
    async show({ params, request, response }) {
        try {
            ...
            let record = await this.modal.getRecordBySlug(request, this.params.id);
            // after show hook
