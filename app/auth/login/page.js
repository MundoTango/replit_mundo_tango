              ...
              <div className="mt-6 px-8 md:px-24">
                ...
                >
                  ...
                  <div>
                    <button
                      type="submit"
                      className={`mt-4 flex w-full items-center justify-center rounded-lg bg-[#EB2560] p-3 text-white outline-none`}
                      disabled={loading}
                    >
                      {loading ? (
                        <div role="status">
                  ...
                  <div className="flex items-center justify-center gap-8 mt-3">
                    <div className="cursor-pointer rounded-xl bg-[#EEEEEE] p-3">
