...
export default function EnhancedMemoryCard({ memory }: EnhancedMemoryCardProps) {
  ...
  const reactionMutation = useMutation({
    mutationFn: async (reactionType: string) => {
      return apiRequest('POST', `/api/memories/${memory.id}/reactions`, { 
        type: reactionType 
      });
    },
    onSuccess: () => {
  ...
  const commentMutation = useMutation({
    mutationFn: async () => {
      return apiRequest('POST', `/api/memories/${memory.id}/comments`, { 
        content: commentText 
      });
    },
    onSuccess: () => {
  ...
  const shareMutation = useMutation({
    mutationFn: async () => {
      return apiRequest('POST', `/api/memories/${memory.id}/share`, { 
        text: shareText 
      });
    },
    onSuccess: () => {
