    ...
    <DashboardLayout>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50/60 via-yellow-50/40 to-orange-50/30 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-40 right-32 w-80 h-80 bg-gradient-to-r from-coral-200/20 to-pink-200/20 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/3 w-48 h-48 bg-gradient-to-r from-blue-gray-200/15 to-indigo-200/15 rounded-full blur-2xl"></div>
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-3 sm:px-5 lg:px-8 py-6">
          ...
          <div className="mb-10 text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start gap-3 mb-4">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black bg-gradient-to-r from-indigo-600 via-blue-600 to-coral-500 bg-clip-text text-transparent">
                Memories
              </h1>
              <Heart className="h-5 w-5 text-coral-400 animate-bounce" />
            </div>
